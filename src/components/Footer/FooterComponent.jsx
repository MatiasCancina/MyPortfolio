...
function FooterComponent() {
  ...
  return (
    <footer className="flex bg-blue100 dark:bg-blue1000 w-full justify-center items-center bg-gray-800 text-white py-6 lg:py-12 px-10 text-center">
      {language === "en" ? (
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="p-2 lg:p-4">
          <a href="https://github.com/MatiasCancina" target="_blank">
            <BsGithub className="text-2xl lg:text-5xl cursor-pointer hover:bg-blue1000/10 dark:hover:bg-blue100/10 rounded-large lg:p-2  text-black dark:text-gray100 mx-6 sm:mx-0" />
          </a>
        </div>
      </div>
    </footer>
