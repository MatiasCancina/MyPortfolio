  ...
  return (
    <div className="col-span-1 row-span-1 lg:col-span-2 lg:row-span-2">
      <div className="grid gap-3 lg:gap-6 2xl:gap-9 w-full">
        <div className="row-span-1 lg:col-span-2 bg-gradient-to-b from-blue200 to-blue500 dark:from-blue800 dark:to-black rounded-3xl p-3 lg:p-8 hover:scale-105 duration-150 flex justify-center items-center">
          <FormContainer />
        </div>
        <div className="hover:scale-110 duration-150 row-span-1 col-span-1 flex justify-center items-center bg-gradient-to-b from-blue200 to-blue500 dark:from-blue800 dark:to-black  rounded-3xl p-3 lg:p-8">
