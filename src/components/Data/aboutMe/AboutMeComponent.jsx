...
const AboutMeComponent = () => {
  return (
    <div className=" bg-blue300 dark:bg-blue800 rounded-3xl col-span-4 lg:col-span-3 p-8">
      <h1 className="text-base lg:text-2xl font-semibold dark:text-gray100">Matías Cancina</h1>
      <p className="font-medium text-xs lg:text-lg p-4 dark:text-gray100">
